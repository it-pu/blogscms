				...
				<div class="widget box">
				    ...
				    <div class="widget-content">
				       <div class="row">
				       	<div class="col-md-12">
				       		<div style="overflow-x: auto;">
				       			<table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable" id="TableGroup">
				       				<thead>
				       					<tr>
				       						<th>No</th>
				       						<th>Group Name</th>
				...
				<div class="widget box">
				    ...
				    <div class="widget-content">
				       <div class="row">
				       	<div class="col-md-12">
				       		<div style="overflow-x: auto;">
				       			<table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable" id="TableMember">
				       				<thead>
				       					<tr>
				       						<th>No</th>
				       						<th>Member Level</th>
				...
				<div class="widget box">
				    ...
				    <div class="widget-content">
				    	...
				    	<div class="row" style="margin-top: 10px;">
				    		<div class="col-md-12">
				    			<div style="overflow-x: auto;">
				    				<table class="table table-striped table-bordered table-hover table-checkable table-responsive datatable" id="TableListMember">
				    					<thead>
				    						<tr>
				    							<th>No</th>
				    							<th>NIP / NPM</th>
